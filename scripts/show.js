...
async function fetchData() {
    try {
        const response = await fetch('https://semicolon23-j8cl.onrender.com/sendNotes');
...
testLink.addEventListener('click', async () => {
    await fetch('https://semicolon23-j8cl.onrender.com/topicType', {
        method: "POST",
        headers: {
    ...
    window.location.href = 'https://semicolon23-j8cl.onrender.com/topicTest';
})