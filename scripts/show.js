...
async function fetchData() {
    try {
        const response = await fetch('https://semicolon.vercel.app/sendNotes');
...
testLink.addEventListener('click', async () => {
    await fetch('https://semicolon.vercel.app/topicType', {
        method: "POST",
        headers: {
    ...
    window.location.href = 'https://semicolon.vercel.app/topicTest';
})